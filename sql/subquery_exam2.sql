...
-- 구매한 도서를 찾고 해당 범위를 반점
-- 박지성이 구매한 도서의 bookid를 찾아내자
...
select *
from customer c
where not exists (select * from orders o where c.custid=o.custid) -- select의 결과가 1행이라도 나오면 참이 됨
;
